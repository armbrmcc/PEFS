                    ...
                    <div class="modal fade" id="exampleModal_<?php echo $i ?>" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <form action="<?php echo site_url() . 'Score_management/Score_management/review'; ?>" method="post"
        ...
        <div class="modal fade" id="Modal_<?php echo $i ?>" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="<?php echo site_url() . 'Score_management/Score_management/next_evaluation'; ?>" method="post"
                        enctype="multipart/form-data">
                        <div class="modal-body">
                            <h5 class="modal-title" id="exampleModalLabel">Date</h5>
                            <input type="date" id="date" name="date" class="form-control"
...
<center><a href="<?php echo site_url() . 'Score_management/Score_management/show_score_management_list'; ?>" class="btn btn-secondary float-center"><i

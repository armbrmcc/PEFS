            ...
            <div class="navbar-inner">
                <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
                    ...
                    if ($id == 2) { ?>
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link " href="<?php echo site_url() . 'Group_management/Group_management/show_group_management'; ?>">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo site_url() . 'File_present_management/File_present_management/show_list_nominee'; ?>">
                                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo site_url() . 'Result_admin/Result_admin/show_result_admin'; ?>">
                                    ...
                                    <span class="nav-link-text ms-1">Result</span></span>
                                </a>
                            </li>
                            <li class="nav-item">

    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-0 fixed-start ms-3 " id="sidenav-main">
        <div class="sidenav-header align-items-center">
            <a class="navbar-brand" href="javascript:void(0)">
                <div align="center">
                    <img src="<?php echo base_url() . 'assests\template\soft-ui-dashboard-main' ?>/assets/img/Logo_DENSO.png" class="navbar-brand-img" alt="main_logo">
                    <!-- <span class="ms-1 font-weight-bold">DENSO</span> -->
                </div>
            </a>
        </div>
            ...
            <div class="navbar-inner">
                <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
                    ...
                    if ($id == 2) { ?>
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link active" href="<?php echo site_url() . 'Group_management/Group_management/show_group_management'; ?>">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo site_url() . 'Form_Management/Form_Management/show_form_management'; ?>">
                                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                    ...
                                    <span class="nav-link-text ms-1">Form Management</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo site_url() . 'Assessor_management/Assessor_management/show_assessor_management'; ?>">
                                    ...
                                    <span class="nav-link-text ms-1">Assessor Management</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo site_url() . 'Score_management/Score_management/show_score_management_list'; ?>">
                                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    ...
                                    <span class="nav-link-text ms-1">Score Management</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo site_url() . 'Report/Report/show_report'; ?>">
                                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo site_url() . 'File_present_management/File_present_management/show_file_present'; ?>">
                                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                        <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <g transform="translate(-2020.000000, -442.000000)" fill="#FFFFFF" fill-rule="nonzero">
                                    ...
                                    <span class="nav-link-text ms-1">Add File Nominee</span>
                                </a>
                            </li>
                        </ul>
                    ...
                    <?php } else if ($id == 1) { ?>
                        <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo site_url() . 'Result/Result/show_result_group_assessor'; ?>">
                                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    <g transform="translate(-1869.000000, -293.000000)" fill="#FFFFFF" fill-rule="nonzero">
